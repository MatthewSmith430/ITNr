...
```{r plotsnet, echo=TRUE,error=FALSE,warning=FALSE}
library(ITNr)
...
```{r plotsingle, echo=TRUE,error=FALSE,warning=FALSE}
library(ITNr)
data("ELEnet16")
...
```{r plotpro, echo=TRUE,error=FALSE,warning=FALSE}
library(ITNr)
data("ELEnet16")
...
```{r plothist, echo=TRUE,error=FALSE,warning=FALSE}
library(ITNr)
data("ELEnet16")
...
```{r plotImEx, echo=TRUE,error=FALSE,warning=FALSE}
library(ITNr)
data("ELEnet16")
...
```{r STRDEGPLOT, echo=TRUE,error=FALSE,warning=FALSE}
library(ITNr)
data("ELEnet16")
...
```{r netprop, echo=TRUE,error=FALSE,warning=FALSE}
library(ITNr)
data("ELEnet16")
...
```{r cent, echo=TRUE,error=FALSE,warning=FALSE}
library(ITNr)
data("ELEnet16")
...
```{r plotBLOCK, echo=TRUE,error=FALSE,warning=FALSE}
library(ITNr)
data("ELEnet16")
